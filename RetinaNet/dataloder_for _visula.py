...
class CocoDataset(Dataset):
    ...
    def __init__(self, root_dir, set_name='valid2017', transform=None):
        """
        Args:
...
class Normalizer(object):
    ...
    def __call__(self, sample):
        ...
        return {'img':((image.astype(np.float32)-self.mean)/self.std), 'annot': annots,'name':name}
